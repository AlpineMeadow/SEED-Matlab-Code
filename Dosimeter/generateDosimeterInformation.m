function info = generateDosimeterInformation(startDayOfYear, startYear, ...
    endDayOfYear, endYear, startHour, startMinute, startSecond, ...
    endHour, endMinute, endSecond)

%This function will fill the information structure.
%This function is called by all of the data analysis scripts.
...
info.endHourStr = num2str(startHour, '%02d');
