function [time, UTCCounts] = setUTCTime(info, time, counts)

%This function is called by FalconSEEDSummarySpectrogram.m, 
%FalconSEEDGeneralSpectrogram.m, FalconDosimeterDoseTimeSeries.m
%and other scripts.	
...
%Create a structure that will hold the two types of time values.
time = struct('eventSeconds', UTCTime, 'eventDateNumber', UTCDateNum');

end  %End of the function setUTCTime.m
