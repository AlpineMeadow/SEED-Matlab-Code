function makeAGUTimeSeries(info, flux, energyBins, UTCTime, numEnergyBinsToSum)
...
sdate, smoothdata(data(timeIndex, lowEnergyBinIndex), 'sgolay', 15), 'b', ...
...
plot(sdate, smoothdata(data(timeIndex, firstEnergyBinIndex), 'sgolay', 15), 'b', ...
    sdate, smoothdata(data(timeIndex, firstEnergyBinIndex + 5), 'g', ...
