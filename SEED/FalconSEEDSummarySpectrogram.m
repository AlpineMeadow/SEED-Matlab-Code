...
info = generateInformationStructure(instrument, startDayOfYear, ...
    startYear, startHour, ...
    startMinute, startSecond, endDayOfYear, endYear, endHour, ...
    endMinute, endSecond, numTimeBinsToSum, numTimeStepsToSkip, ...
    CDFDataVersionNumber, startEnergy, endEnergy, startEnergyBinNumber, ...
    numEnergyBinsToSum);
