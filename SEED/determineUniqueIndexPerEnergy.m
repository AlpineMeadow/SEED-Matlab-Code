...
%sorted. 
[C1, uniqueSEEDDataIndex1, ic1] = unique(rawSEEDData(:, energyBin1), 'rows', 'stable');
[C2, uniqueSEEDDataIndex2, ic2] = unique(rawSEEDData(:, energyBin2), 'rows', 'stable');
[C3, uniqueSEEDDataIndex3, ic3] = unique(rawSEEDData(:, energyBin3), 'rows', 'stable');
...
if makePlot == 1
    ...
    E1Str = ['Energy : ', num2str(E1), ' keV - Unique Events : ', num2str(numEnergyBin1)];
    E2Str = ['Energy : ', num2str(E2), ' keV - Unique Events : ', num2str(numEnergyBin2)];
    E3Str = ['Energy : ', num2str(E3), ' keV - Unique Events : ', num2str(numEnergyBin3)];
