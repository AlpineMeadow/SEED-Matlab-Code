function makeLineSpectra(info, flux, energyBins, UTCTime, numEnergyBinsToSum)
...
titleStr = satellite + " " + instrument + " " + plotType + " " + ...
    startDate + " " + startDayOfYear;
    
saveName = satellite + instrument + plotType + startDate + "_" + startDayOfYear;


outFileName = strcat(info.SEEDPlotDir, 'LineSpectra/', saveName, '.png');
...
end  %End of the function makeLineSpectra.m