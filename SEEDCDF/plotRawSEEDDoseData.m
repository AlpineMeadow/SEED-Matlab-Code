function plotRawSEEDDoseData(info, rawSEEDData, rawDosimeterData)
...
numEvents = length(rawDosimeterData.DOSETime);

%Lets set the time to start from 0 and also be fractions of seconds.
time = (rawDosimeterData.DOSETime - rawDosimeterData.DOSETime(1));
