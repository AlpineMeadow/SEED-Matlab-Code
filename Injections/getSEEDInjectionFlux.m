function flux = getSEEDInjectionFlux(info, time, Counts)

%This function is called by makeSEEDInjectionPlots.m
...
for e = 1 : numEnergyBins
    ...
    for t = 1 : numEvents
        ...
        countsToFlux = 1.0/(deltaE*geometricFactor(e)*15.0);
...
end  %End of the function getSEEDInjectionFlux.m